...
<!-- <link rel="stylesheet" href="https://me2.do/5BvBFJ57"> -->
    ...
    <body id="top">
    	...
    	<section class="d-flex justify-content-center align-items-center top_quick_list">
            <div class="container display-flex">
		    		<div class="quick_menu"><strong>자격증</strong></div>
		    		<div class="quick_menu"><strong>교재</strong></div>
		    		<div class="quick_menu"><strong>학원</strong></div>
		    		<div class="quick_menu"><strong>로그인</strong></div>
    		</div>
		</section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex flex-wrap align-items-center mt-4 mt-lg-0">
                                            ...
                                            <div>
                                                <a href="jobListings.do" class="badge">Web design</a>

                                                <a href="jobListings.do" class="badge">Marketing</a>

                                                <a href="jobListings.do" class="badge">Customer support</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-text-block">
                                ...
                                <div class="custom-border-btn-wrap d-flex align-items-center mt-5">
                                    <a href="about.do" class="custom-btn custom-border-btn btn me-4">Get to know us</a>
                        ...
                        <div class="col-lg-12 col-12">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="jobDetails.do" class="job-title-link">Technical Lead</a>
                                        </h4>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge badge-level">Internship</a>
                                                </p>

                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge">Freelance</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="job-section-btn-wrap">
                                        <a href="jobDetails.do" class="custom-btn btn">Apply now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="jobDetails.do" class="job-title-link">Business Director</a>
                                        </h4>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge badge-level">Senior</a href="jobListings.do">
                                                </p>

                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge">Full Time</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="jobDetails.do" class="job-title-link">HR Manager</a>
                                        </h4>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge badge-level">Junior</a>
                                                </p>

                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge">Contract</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="jobDetails.do" class="job-title-link">Dev Ops</a>
                                        </h4>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge badge-level">Senior</a>
                                                </p>

                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge">Part Time</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="jobDetails.do" class="job-title-link">UX Designer</a>
                                        </h4>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge badge-level">Entry</a>
                                                </p>

                                                <p class="mb-0">
                                                    <a href="jobListings.do" class="badge">Remote</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="job-thumb job-thumb-box">
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center border-top pt-3">
                                        ...
                                        <a href="jobDetails.do" class="custom-btn btn ms-auto">Apply now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="jobDetails.do" class="job-title-link">Marketing Assistant</a>
                                    </h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="jobDetails.do" class="job-title-link">Programmer</a>
                                    </h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="jobDetails.do" class="job-title-link">Sales Representative</a>
                                    </h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    ...
                                    <div class="job-image-box-wrap-info d-flex align-items-center">
                                        <p class="mb-0">
                                            <a href="jobListings.do" class="badge badge-level">Mid Level</a>
                                        </p>
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="jobDetails.do" class="job-title-link">Graphic Designer</a>
                                    </h4>
                        ...
                        <div class="col-lg-4 col-12 recent-jobs-bottom d-flex ms-auto my-4">
                            <a href="jobListings.do" class="custom-btn btn ms-lg-auto">Browse Job Listings</a>
                        </div>
