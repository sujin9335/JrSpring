...
body > main > div.container-fluid.py-4 > div > div > div > div.card-body.px-0.pt-0.pb-2 > div > form > table > thead > tr > td {
	padding-left: 50px;
}
.button-79 {
...
.navbar-vertical.bg-white .navbar-nav>.nav-item .nav-link.academy {

  box-shadow: none;
  background-color: #f6f9fc;
} 

.navbar-vertical .navbar-nav .nav-link.academy {
  font-weight: 600;
	...
	<aside
		...
		<div class="collapse navbar-collapse  w-auto "
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link academy"
					...
					<div class="card mb-4">
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<form method="POST" action="/jr/admin/academyadminaddok.do">
									<table class="table align-items-center mb-0">
										<thead>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">학원명
												</th>
												<td><input type="text" name="academyName" required
													value="${dto.academyName}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">위치
												</th>
												<td><input type="text" name="academylocation" required
													value="${dto.academylocation}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">연락처
												</th>
												<td><input type="text" name="academyTel" required
													value="${dto.academyTel}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">평점</th>
												<td><input type="text" name="academyStar" required
													value="${dto.academyStar}"></td>
											</tr>
										</tbody>
									</table>
									...
									<div class="button-group">
										...
										<button class="button-79" role="button"
											onclick="location.href='/jr/admin/academy/academyadminlist.do';">돌아가기</button>
									</div>
								</form>
