						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<table class="table align-items-center mb-0">
									<tbody>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">학원명</th>
													<td>${dto.academyName}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">학원 위치</th>
													<td>${dto.academylocation}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">학원 연락처</th>
													<td>${dto.academyTel}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">평점</th>
										...
										<div class="button-group">
											<button class="button-79" role="button"
												onclick="location.href='/jr/admin/academy/academyadminlist.do';">목록</button>
										</div>
									</tbody>
							</div>
						</div>
