						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<button class="button-79" role="button"
									onclick="location.href='/jr/admin/academy/academyadminadd.do';">등록하기</button>
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">번호</th>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">학원명</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">위치
											</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">평점</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${list}" var="dto" varStatus="status">
											<tr>
												<td>${dto.academySeq}</td>
												<td><a
													href="/jr/admin/academy/academyadmindetail.do?academySeq=${dto.academySeq}">${dto.academyName}</a></td>
