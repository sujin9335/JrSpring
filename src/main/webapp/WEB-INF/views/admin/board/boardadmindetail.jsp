							...
							<div class="table-responsive p-0">
								<table class="table align-items-center mb-0">
									<tbody>
										...
										<tr>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">작성자</th>
											<td>${dto.id}</td>
										</tr>
										<tr>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">작성일</th>
								...
								<div class="button-group">
									<button class="button-79" role="button"
										onclick="location.href='/jr/admin/board/boardadminlist.do';">목록</button>
								</div>
								</tbody>
							</div>
						</div>
