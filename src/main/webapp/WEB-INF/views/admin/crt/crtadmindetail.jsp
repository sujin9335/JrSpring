...
body > main > div.container-fluid.py-4 > div > div > div > div.card-body.px-0.pt-0.pb-2 > div > table.board-table > tbody > tr:nth-child(1) > th {
	width: 100px;
}

body > main > div.container-fluid.py-4 > div > div > div > div.card-body.px-0.pt-0.pb-2 > div > table.board-table > tbody > tr:nth-child(1) > td {
	width: 500px;
}
		...
		<nav
			...
			<div class="container-fluid py-1 px-3">
				<nav aria-label="breadcrumb">
					...
					<h6 class="font-weight-bolder text-white mb-0">상세페이지</h6>
				</nav>
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<table class="table align-items-center mb-0">
									<tbody>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">자격증명</th>
													<td>${dto.crtName}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">자격증 분류</th>
													<td>${dto.crtType}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">유효기간</th>
													<td>${dto.expiration}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">시행기관</th>
													<td>${dto.agencyName}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">정기유무</th>
													<td>${dto.isRoutine}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">난이도</th>
													<td>${dto.difficulty}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">좋아요수</th>
													<td>${dto.likeCnt}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">응시자격 분류</th>
													<td>${dto.qualificationCate}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">응시자격</th>
													<td>${dto.qualification}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">자격증 설명</th>
													<td>${dto.crtInfo}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">누적 응시자수</th>
													<td>${dto.totalCnt}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">직무 내용</th>
													<td>${dto.jobDesc}</td>
												</tr>
											</tbody>
										</table>
										<div class="button-group">
											<button class="button-79" role="button"
												onclick="location.href='/jr/admin/crt/crtadminlist.do';">목록</button>
										</div>
									</tbody>
							</div>
						</div>
