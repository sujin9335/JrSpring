...
body>main>div.container-fluid.py-4>div>div>div>div.card-body.px-0.pt-0.pb-2>div>form>table>thead>tr:nth-child(7)>td>textarea
	{
	width: 500px;
}

body>main>div.container-fluid.py-4>div>div>div>div.card-body.px-0.pt-0.pb-2>div>form>table>thead>tr:nth-child(8)>td>textarea
	{
	width: 500px;
}

body>main>div.container-fluid.py-4>div>div>div>div.card-body.px-0.pt-0.pb-2>div>form>table>thead>tr:nth-child(9)>td>textarea
	{
	width: 500px;
}

body>main>div.container-fluid.py-4>div>div>div>div.card-body.px-0.pt-0.pb-2>div>form>table>thead>tr:nth-child(11)>td>textarea
	{
	width: 500px;
}
					...
					<div class="card mb-4">
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<form method="POST" action="/jr/admin/crtadminaddok.do">
									<table class="table align-items-center mb-0">
										<thead>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">자격증명
												</th>
												<td><input type="text" name="crtName" required
													value="${dto.crtName}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">자격증
													분류 번호</th>
												<td><input type="text" name="crtTypeSeq" required
													value="${dto.crtTypeSeq}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">유효기간
												</th>
												<td><input type="text" name="expiration" required
													value="${dto.expiration}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">시행기관
													번호</th>
												<td><input type="text" name="agencySeq" required
													value="${dto.agencySeq}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">정기유무
												</th>
												<td><input type="text" name="isRoutine" required
													value="${dto.isRoutine}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">난이도
												</th>
												<td><input type="text" name="difficulty" required
													value="${dto.difficulty}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">응시자격
													분류</th>
											...
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">직무내용
												</th>
									...
									<div class="button-group">
										...
										<button class="button-79" role="button"
											onclick="location.href='/jr/admin/crt/crtadminlist.do';">돌아가기</button>
									</div>
								</form>
