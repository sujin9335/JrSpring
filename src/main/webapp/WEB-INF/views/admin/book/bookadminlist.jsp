...
.navbar-vertical.bg-white .navbar-nav>.nav-item .nav-link.book {
	box-shadow: none;
	background-color: #f6f9fc;
}

.navbar-vertical .navbar-nav .nav-link.book {
	font-weight: 600;
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<button class="button-79" role="button"
									onclick="location.href='/jr/admin/book/bookadminadd.do';">등록하기</button>
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											...
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">교재명</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">출판일</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">저자</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">가격</th>
									...
									<tbody>
										<c:forEach items="${list}" var="dto" varStatus="status">
											<tr>
												<td>${dto.bookSeq}</td>
												<td><a
													href="/jr/admin/book/bookadmindetail.do?bookSeq=${dto.bookSeq}">${dto.bookName}</a></td>
												<td>${dto.pbDate}</td>
												<td>${dto.author}</td>
