						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<table class="table align-items-center mb-0">
											<tbody>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">교재명</th>
													<td>${dto.bookName}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">출판사</th>
													<td>${dto.publisher}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">가격</th>
													<td>${dto.price}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">출판일</th>
													<td>${dto.pbDate}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">저자</th>
													<td>${dto.author}</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td><img src="<c:out value='${dto.bookImg}' />" alt="도서 이미지" width="200" height="300"></td>
												</tr>
											</tbody>
										</table>
										<div class="button-group">
											<button class="button-79" role="button"
												onclick="location.href='/jr/admin/book/bookadminlist.do';">목록</button>
										</div>
									</tbody>
							</div>
						</div>
