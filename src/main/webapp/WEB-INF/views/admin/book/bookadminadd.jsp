					...
					<div class="card mb-4">
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<form method="POST" action="/jr/admin/bookadminaddok.do">
									<table class="table align-items-center mb-0">
										<thead>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">교재명
												</th>
											...
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">출판사
												</th>
											...
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">가격
												</th>
											...
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">출판일</th>
												<td><input type="text" name="pbDate" required
													value="${dto.pbDate}"></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">저자
												</th>
												...
												<td><input type="text" name="lv" required
													value="${dto.lv}"></textarea></td>
											</tr>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">이미지
												</th>
												<td><input type="text" name="bookImg" required
													value="${dto.bookImg}"></td>
											</tr>
										</tbody>
									</table>
									...
									<div class="button-group">
										...
										<button class="button-79" role="button"
											onclick="location.href='/jr/admin/book/bookadminlist.do';">돌아가기</button>
									</div>
								</form>
