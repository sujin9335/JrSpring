...
.navbar-vertical.bg-white .navbar-nav>.nav-item .nav-link.forbidden {
	box-shadow: none;
	background-color: #f6f9fc;
}

.navbar-vertical .navbar-nav .nav-link.forbidden {
	font-weight: 600;
	...
	<aside
		...
		<div class="collapse navbar-collapse  w-auto "
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link forbidden"
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<button class="button-79" role="button"
									onclick="location.href='/jr/admin/forbidden/forbiddenadminadd.do';">등록하기</button>
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											...
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">금지어</th>
										</tr>
									</thead>
									<tbody>
