...
.navbar-vertical.bg-white .navbar-nav>.nav-item .nav-link.depart {
	box-shadow: none;
	background-color: #f6f9fc;
}

.navbar-vertical .navbar-nav .nav-link.depart {
	font-weight: 600;
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<button class="button-79" role="button"
									onclick="location.href='/jr/admin/depart/departadminadd.do';">등록하기</button>
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											...
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">학과명</th>
										</tr>
									...
									<tbody>
										<c:forEach items="${list}" var="dto" varStatus="status">
											<tr class="hoverable-row"
												onclick="window.location='/jr/admin/depart/departadmindetail.do?departSeq=${dto.departSeq}'">
												<td>${dto.departSeq}</td>
