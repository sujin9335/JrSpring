					...
					<div class="card mb-4">
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<form method="POST" action="/jr/admin/departadminaddok.do">
									<table class="table align-items-center mb-0">
										<thead>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">학과
												</th>
												<td><input type="text" name="departName" required
													value="${dto.departName}"></td>
											</tr>
										</tbody>
									</table>
									...
									<div class="button-group">
										...
										<button class="button-79" role="button"
											onclick="location.href='/jr/admin/depart/departadminlist.do';">돌아가기</button>
									</div>
								</form>
