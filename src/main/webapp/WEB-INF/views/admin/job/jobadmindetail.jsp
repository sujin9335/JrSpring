						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<table class="table align-items-center mb-0">
											<tbody>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">직업명</th>
													<td>${dto.jobName}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">직업군명</th>
													<td>${dto.jobgroupName}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">핵심업무</th>
													<td>${dto.keyTask}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">연봉</th>
													<td>${dto.salary}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">전망</th>
													<td>${dto.prospect}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">발전가능성</th>
													<td>${dto.dvlPossibility}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">적성 및 흥미</th>
													<td>${dto.aptitude}</td>
												</tr>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">하는일</th>
													<td>${dto.task}</td>
												</tr>
											</tbody>
										</table>
										<div class="button-group">
											<button class="button-79" role="button"
												onclick="location.href='/jr/admin/job/jobadminlist.do';">목록</button>
										</div>
									</tbody>
							</div>
						</div>
