...
.navbar-vertical.bg-white .navbar-nav>.nav-item .nav-link.job {
	box-shadow: none;
	background-color: #f6f9fc;
}

.navbar-vertical .navbar-nav .nav-link.job {
	font-weight: 600;
	...
	<aside
		...
		<div class="collapse navbar-collapse  w-auto "
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item">
				<a class="nav-link active" href="/jr/admin/crt/crtadminlist.do">
				...
				<li class="nav-item">
				<a class="nav-link job" href="/jr/admin/job/jobadminlist.do">
						<div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<button class="button-79" role="button"
									onclick="location.href='/jr/admin/job/jobadminadd.do';">등록하기</button>
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											...
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">직업명</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">직업군</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${list}" var="dto" varStatus="status">
											<tr class="hoverable-row"
												onclick="window.location='/jr/admin/job/jobadmindetail.do?jobSeq=${dto.jobSeq}'">
												<td>${dto.jobSeq}</td>
												<td>${dto.jobName}</td>
