						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<table class="table align-items-center mb-0">
											<tbody>
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">회원명</th>
													<td>${dto.name}</td>
												</tr>
												<tr>
												...
												<tr>
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">생년월일</th>
													<td>${dto.birthDate}</td>
												</tr>
												<tr>
										...
										<div class="button-group">
											<button class="button-79" role="button"
												onclick="location.href='/jr/admin/user/useradminlist.do';">목록</button>
										</div>
									</tbody>
							</div>
						</div>
