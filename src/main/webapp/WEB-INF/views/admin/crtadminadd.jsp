		...
		<div class="container-fluid py-4">
			<div class="row">
				<div class="col-12">
         		...
         		<tr>
           			<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">자격증 분류 번호 </th>
         		...
         		<tr>
            		<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">시행기관 번호</th>
         		...
         		<tr>
         		<tr>
            		<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">직무내용 </th>
            		<td><textarea name="jobDesc" required>${dto.jobDesc}</textarea></td>
									...
									<button class="button-79" role="button">등록하기</button>
										<button class="button-79" role="button"
											onclick="location.href='/jr/admin/crtadminlist.do';">돌아가기</button>
									</div>
								</form>
