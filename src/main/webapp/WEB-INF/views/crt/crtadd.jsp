		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-8 col-12 mx-auto">
					<form class="custom-form contact-form" action="/jr/crt/add.do" method="POST"
						role="form">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-5 col-sm-6 mx-auto d-flex flex-row">
								...
								<button type="button" class="form-control" onclick="location.href='/jr/crt/crtboardlist.do?crtSeq=${dto.crtSeq}'">취소</button>
							</div>
						</div>
					</form>
				</div>
