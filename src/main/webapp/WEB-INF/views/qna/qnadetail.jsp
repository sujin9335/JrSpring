	...
	<section class="job-section section-padding pb-0 pt-4">
		<div class="container">
			<div class="row">
				...
				<div class="col-12">
					<h3 class="job-title mb-0"> &nbsp; &nbsp;${ dto.qnaTitle }</h3>
...
<%-- 
						...
						<div class="d-flex justify-content-center flex-wrap pt-4">
							<div class="col-11 board-content" style=white-space;>${ dto.qnaContent }</div>
				...
				<%-- 		<div
							...
							<a href="/jr/qna/qna.do" class="custom-btn btn mt-2 mb-5">목록</a>
							<c:if test="${ id == dto.id }">
